export const menus = [
    ...
    {
        key: '/app/order', title: 'ccp2', icon: 'tool',
        sub: [
    ...
    {
        key: '/app/user', title: 'ccp4', icon: 'user',
        sub: [
            { key: '/app/user/list', title: '会员公海', icon: '', },
            { key: '/app/user/chart', title: '图表', icon: '', },
        ],
    },
    {
        key: '/app/employee', title: 'ccp5', icon: 'idcard',
        sub: [
            { key: '/app/employee/list', title: '员工菜单', icon: '', },
            { key: '/app/employee/chart', title: '图表', icon: '', },
        ],
    },
    {
